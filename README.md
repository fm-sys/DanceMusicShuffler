...
⚠️ As we use the Spotify WebAPI in development mode, we need to manually add your Spotify user account to the list of authorized users before you can access the API:
